...
12. Write verdict JSON to: $DESK/memos/$SLUG-verify-verdict.json
    **CRITICAL: You MUST write the verdict as a FILE using a file-writing tool (not stdout/echo/cat). NEVER print the verdict JSON to the terminal. The Leader polls this file path — terminal output is lost. Keep evidence strings under 200 chars each to avoid output token limits.**
