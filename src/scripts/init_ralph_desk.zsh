...
print_run_presets() {
  ...
  echo "#   --worker-model MODEL                   haiku|sonnet|opus or gpt-5.6-sol:high|luna:high|spark:high (default: haiku)"
  ...
  echo "#   --final-consensus-model MODEL          final cross-verifier (default: gpt-5.6-sol:xhigh)"
