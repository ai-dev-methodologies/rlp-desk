...
# ------------------------------------------------------------------
assert_one "$LOOP" 'async function writeSentinel\(filePath, status, usId, reason, classification' \
  "AC9-a: writeSentinel signature includes reason + classification (P1-D)"
