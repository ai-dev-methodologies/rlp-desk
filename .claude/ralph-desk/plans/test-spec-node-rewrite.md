...
| US-008 | AC8.1 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.1 happy: postinstall installs the Node runtime under ~/.claude/ralph-desk and removes legacy zsh scripts | L1 | node --test --test-name-pattern "US-008 AC8.1 happy" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.1 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.1 boundary: postinstall replaces a mixed installation with the Node runtime on reinstall | L1 | node --test --test-name-pattern "US-008 AC8.1 boundary" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.1 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.1 negative: uninstall removes the installed Node runtime files | L1 | node --test --test-name-pattern "US-008 AC8.1 negative" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.2 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.2 happy: the run command parses tmux example flags and launches the campaign with the expected configuration | L1 | node --test --test-name-pattern "US-008 AC8.2 happy" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.2 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.2 boundary: the run command applies the documented defaults when optional flags are omitted | L1 | node --test --test-name-pattern "US-008 AC8.2 boundary" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.2 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.2 negative: the run command rejects unknown flags instead of launching with a silent parse failure | L1 | node --test --test-name-pattern "US-008 AC8.2 negative" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.3 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.3 happy: node src/node/run.mjs --help lists every top-level command in the current CLI interface | L1 | node --test --test-name-pattern "US-008 AC8.3 happy" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.3 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.3 boundary: node src/node/run.mjs --help includes every run flag from the current interface with no missing options | L1 | node --test --test-name-pattern "US-008 AC8.3 boundary" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.3 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.3 negative: node src/node/run.mjs rejects an unknown command with a clear help hint | L1 | node --test --test-name-pattern "US-008 AC8.3 negative" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.4 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.4 happy: postinstall falls back gracefully on unsupported Node and preserves an existing zsh installation | L1 | node --test --test-name-pattern "US-008 AC8.4 happy" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.4 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.4 boundary: postinstall treats Node 16 as supported and installs the Node runtime | L1 | node --test --test-name-pattern "US-008 AC8.4 boundary" tests/node/us008-cli-entrypoint.test.mjs | complete |
| US-008 | AC8.4 | tests/node/us008-cli-entrypoint.test.mjs :: US-008 AC8.4 negative: postinstall treats malformed Node versions as unsupported without corrupting the current installation | L1 | node --test --test-name-pattern "US-008 AC8.4 negative" tests/node/us008-cli-entrypoint.test.mjs | complete |
...
| US-008 | AC8.1 | L1 | node:test | node --test --test-name-pattern "US-008 AC8.1" tests/node/us008-cli-entrypoint.test.mjs | 3 tests pass | exit 0 + happy, boundary, and negative AC8.1 install/uninstall tests pass |
| US-008 | AC8.2 | L1 | node:test | node --test --test-name-pattern "US-008 AC8.2" tests/node/us008-cli-entrypoint.test.mjs | 3 tests pass | exit 0 + happy, boundary, and negative AC8.2 CLI parse tests pass |
| US-008 | AC8.3 | L1 | node:test | node --test --test-name-pattern "US-008 AC8.3" tests/node/us008-cli-entrypoint.test.mjs | 3 tests pass | exit 0 + happy, boundary, and negative AC8.3 help-surface tests pass |
| US-008 | AC8.4 | L1 | node:test | node --test --test-name-pattern "US-008 AC8.4" tests/node/us008-cli-entrypoint.test.mjs | 3 tests pass | exit 0 + happy, boundary, and negative AC8.4 fallback tests pass |
| US-008 | AC8.1-AC8.4 | L1 | node:test happy-path subset | node --test --test-name-pattern "US-008 AC8.1 happy|US-008 AC8.2 happy|US-008 AC8.3 happy|US-008 AC8.4 happy" tests/node/us008-cli-entrypoint.test.mjs | 4 tests pass | exit 0 + install, run parsing, help, and unsupported-node fallback happy-path tests pass |
| US-008 | AC8.1-AC8.4 | L1 | node:test boundary subset | node --test --test-name-pattern "US-008 AC8.1 boundary|US-008 AC8.2 boundary|US-008 AC8.3 boundary|US-008 AC8.4 boundary" tests/node/us008-cli-entrypoint.test.mjs | 4 tests pass | exit 0 + reinstall, default parsing, full help coverage, and Node 16 boundary tests pass |
| US-008 | AC8.1-AC8.4 | L1 | node:test error-path subset | node --test --test-name-pattern "US-008 AC8.1 negative|US-008 AC8.2 negative|US-008 AC8.3 negative|US-008 AC8.4 negative" tests/node/us008-cli-entrypoint.test.mjs | 4 tests pass | exit 0 + uninstall cleanup, unknown-flag rejection, unknown-command rejection, and malformed-version fallback tests pass |
| US-008 | AC8.1-AC8.4 | L1/L3 | node:test smoke | node --test tests/node/us008-cli-entrypoint.test.mjs | 12 tests pass | exit 0 + full CLI/npm integration suite passes |
